...
# Criar o banco de dados e cursor
conexao = sql.connect('gama.bd')
...
cursor.execute(create_table_alunos)

# Popular a tabela
insert_values_alunos = '''
...
cursor.execute(insert_values_alunos)

# Salvar as alterações
conexao.commit()

# Conferir a criação da tabela
#fetchone -> retorna 1 linha -> tupla (...) -> (31,)
#fetchall -> retorna todas as linhas -> lista [(...), (...)...] -> [(31,)]
